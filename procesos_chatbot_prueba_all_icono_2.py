        ...
        (
            ...
            (
               ...
               "\nCuando identifiques un proceso (o procesos) que tenga relación con la consulta, **debes seguir estrictamente los siguientes pasos** (formatea la respuesta de manera clara y organizada)\n"
                ...
                "2. Obligatorio: **muestra el enlace clickeable con el texto 'Ver flujograma' al lado del código del proceso (en todos los casos debes utilizar el link del campo link-flujograma, NUNCA MUESTRES LA IMAGEN solo deseo el link clickeable) **, ** al lado muestra esta imagen https://compras135.ufm.edu/reportesai/icono_flujo.png ** \n"
